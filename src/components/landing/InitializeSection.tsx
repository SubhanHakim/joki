            ...
            <div className="p-8 md:p-12 rounded-2xl border border-gray-800 bg-gradient-to-b from-gray-900/50 to-black backdrop-blur relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-4">
                        <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="px-8 py-3.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-medium transition-all duration-300 flex items-center gap-2 w-full md:w-auto justify-center group">
